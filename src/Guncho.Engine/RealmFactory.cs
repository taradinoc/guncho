...
namespace Guncho
{
    public abstract class RealmFactory
    {
        ...
        protected readonly IServerConfiguration config;

        protected RealmFactory(string factoryName, IServerConfiguration config)
        {
        ...
        protected static /*async*/ Task<string> ExecuteAsync(string exeName, int timeoutMilliseconds, string homeDir, params string[] args)
        {
            ...
            using (Process proc = new Process())
            {
                ...
                //var timedOut = Task.Delay(timeoutMilliseconds);
