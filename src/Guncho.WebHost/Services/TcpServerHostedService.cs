...
namespace Guncho.WebHost.Services
{
    ...
    public class TcpServerHostedService : IHostedService
    {
        ...
        {
            _logger.LogMessage(LogLevel.Notice, "TCP Server: Starting on port {0}...", _config.GameServerPort);
            ...
            _logger.LogMessage(LogLevel.Notice, "TCP Server: Listening on port {0}.", _config.GameServerPort);
        ...
        {
            _logger.LogMessage(LogLevel.Notice, "TCP Server: Stopping...");
            ...
            _logger.LogMessage(LogLevel.Notice, "TCP Server: Stopped.");
        }

        private void OnTcpConnectionAccepted(object? sender, ConnectionAcceptedEventArgs<TcpConnection> e)
        {
            _logger.LogMessage(LogLevel.Verbose, "TCP: Accepting connection from {0}.", FormatEndPoint(e.Connection.OtherSide));
        ...
        {
            _logger.LogMessage(LogLevel.Notice, "TCP: Connection closed from {0}.", FormatEndPoint(e.Connection.OtherSide));
